...
#define PIN_CLK_GPIO        GPIOA
#define PIN_CLK             GPIO_PINS_5

#define PIN_DIO_O_GPIO      GPIOA
#define PIN_DIO_O           GPIO_PINS_7
#define PIN_DIO_I_GPIO      GPIOA
#define PIN_DIO_I           GPIO_PINS_6

#define PIN_nRESET_GPIO     GPIOC
#define PIN_nRESET          GPIO_PINS_14
...
__STATIC_INLINE void PORT_SWD_SETUP (void) {
    ...
    gpio_initstruct.gpio_pins = PIN_CLK | PIN_DIO_O;
    gpio_initstruct.gpio_pull = GPIO_PULL_NONE;
    gpio_init(PIN_CLK_GPIO, &gpio_initstruct);
    gpio_bits_set(PIN_CLK_GPIO, PIN_CLK | PIN_DIO_O);
    
    // DIO IN
    gpio_initstruct.gpio_mode = GPIO_MODE_INPUT;
    gpio_initstruct.gpio_pins = PIN_DIO_I;
    gpio_initstruct.gpio_pull = GPIO_PULL_NONE;
    gpio_init(PIN_DIO_I_GPIO, &gpio_initstruct);

    // NRST
    gpio_initstruct.gpio_out_type = GPIO_OUTPUT_OPEN_DRAIN;
    gpio_initstruct.gpio_pins = PIN_nRESET;
    gpio_initstruct.gpio_pull = GPIO_PULL_UP;
    gpio_init(PIN_nRESET_GPIO, &gpio_initstruct);
    gpio_bits_set(PIN_nRESET_GPIO, PIN_nRESET);
}
...
__STATIC_INLINE void PORT_OFF (void) {
    ...
    gpio_initstruct.gpio_mode = GPIO_MODE_INPUT;
    gpio_initstruct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
    gpio_initstruct.gpio_pins = PIN_CLK | PIN_DIO_O | PIN_DIO_I | PIN_nRESET;
    gpio_initstruct.gpio_pull = GPIO_PULL_NONE;
    gpio_init(PIN_CLK_GPIO, &gpio_initstruct);
}
...
__STATIC_FORCEINLINE uint32_t PIN_SWCLK_TCK_IN  (void) {
    return (PIN_CLK_GPIO->odt & PIN_CLK) != RESET;
}
...
__STATIC_FORCEINLINE uint32_t PIN_SWDIO_TMS_IN  (void) {
    return (PIN_DIO_O_GPIO->odt & PIN_DIO_O) != RESET;
}
...
__STATIC_FORCEINLINE uint32_t PIN_SWDIO_IN      (void) {
  return (PIN_DIO_I_GPIO->idt & PIN_DIO_I) != RESET;
}
...
__STATIC_FORCEINLINE uint32_t PIN_nRESET_IN  (void) {
    return (PIN_nRESET_GPIO->odt & PIN_nRESET) != RESET;
}
