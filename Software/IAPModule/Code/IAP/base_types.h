...
#define IAP_TRANSFER            1
#define MODEM_TRANSFER          2

#define TRANS_PROCESSING        0
#define IAP_TRANS_SUCCESS       1
#define IAP_TRANS_FAILED        2
#define MODEM_TRANS_SUCCESS     3
#define MODEM_TRANS_FAILED      4 
